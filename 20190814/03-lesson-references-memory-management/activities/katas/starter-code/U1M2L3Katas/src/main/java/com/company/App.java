...
public class App {
    ...
    public TV createTV(){
        TV tv = new TV("Zenith", "U2121H", 83, "NBC",
                55, false);
    ...
    public Microwave createMicrowave(){
        Microwave microwave = new Microwave("Haier", "X1200w", 45,
                "12:00", false);
    ...
    public CoffeeMaker createCoffeeMaker(){
        CoffeeMaker coffeeMaker = new CoffeeMaker("Sunbeam", "C12",
                12, 8, true);
    ...
    public Car createCar(){
        Car car = new Car("Honda", "Accord", "Sedan", "Blue", "2.6L V6",
                "CVT", 4, 31.7, 25218);
